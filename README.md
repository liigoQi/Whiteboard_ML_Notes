...
最近在看B站上的[白板推导系列课程](https://www.bilibili.com/video/BV1aE411o7qd)，老师讲得很好，内容也很充实。发现自己从基础的数学到高级的算法掌握得都不太好，所以详细地做了一下笔记，尽力覆盖没讲到的一些细节，同时在这个readme记录一下比较有参考性的资料，方便之后再看。难免有错漏，请看到的朋友指出。
